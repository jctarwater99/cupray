  ...
  return (
    <View style={{flex:1}}>
       ...
       <View style={{flex:20, backgroundColor: "#00FF00"}} />
         ...
         {/*Buttons 1 */}
         <View style={{flex:15, flexDirection: "row", backgroundColor: "#0000FF"}}>
            <View style={{flex: 2, backgroundColor: "#FFFF00"}}></View> 
            <View style={{flex: 2, backgroundColor: "#00FFFF"}}></View> 
        </View>
        
        {/*Buttons 2 */}
        <View style={{flex:15, flexDirection: "row", backgroundColor: "#FF0000"}}>
